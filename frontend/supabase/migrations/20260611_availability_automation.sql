-- ══════════════════════════════════════════════════════════════════════════════
-- Migración: Automatización de Próxima Disponibilidad y Estados de Alquiler
-- Descripción:
--   1. Modifica update_property_commercial_status_from_contracts para actualizar 'availability' de propiedades y habitaciones
--   2. Modifica refresh_all_property_commercial_statuses para procesar fechas de expiración manuales y sincronizar
-- ══════════════════════════════════════════════════════════════════════════════
