...
ADD COLUMN IF NOT EXISTS is_manual_commercial_status boolean NOT NULL DEFAULT false;

-- 2. Update the function that recalculates status from contracts
...
-- 3. Update the cron function to skip manual properties
