...
6. **Idioma**: Aunque parte de los datos provengan de documentos originalmente en otros idiomas (como inglés o italiano), el resumen ejecutivo final debe ser redactado única y exclusivamente en ESPAÑOL.
