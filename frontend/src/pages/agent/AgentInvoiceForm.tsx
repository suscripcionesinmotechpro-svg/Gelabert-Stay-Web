...
export const AgentInvoiceForm = () => {
  ...
  useEffect(() => {
    ...
    const load = async () => {
      ...
      if (error || !data) { navigate('/agente/facturas'); return; }
    ...
    <div className="flex flex-col gap-6 max-w-4xl mx-auto pb-20">
      ...
      <div className="flex items-center justify-between gap-4">
        <div className="flex items-center gap-3">
          <button onClick={() => navigate('/agente/facturas')} className="text-[#888888] hover:text-[#FAF8F5] transition-colors"><ChevronLeft className="w-5 h-5" /></button>
          <div>
