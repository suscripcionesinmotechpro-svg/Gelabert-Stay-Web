...
export const AgentPropertyReorder = () => {
        ...
        <div className="relative z-10 w-full flex flex-col md:flex-row items-center justify-between gap-6">
          <div className="flex flex-col gap-2">
            <div className="flex items-center gap-3 mb-2">
              <Link to="/agente/propiedades" className="p-2 bg-white/5 border border-white/10 rounded-full text-white/40 hover:text-[#C9A962] hover:border-[#C9A962] transition-all">
