...
import { 
  ...
  Calendar, X, ChevronRight, ExternalLink, Download, Printer, Sparkles
} from 'lucide-react';
      ...
      <body>
        <header>
          ...
          <div class="meta-info">
            ...
            <div style="color: #d4d4d8; margin-top: 5px;">Agente: <strong>${agentName}</strong></div>
            <div style="color: #d4d4d8; margin-top: 2px;">Generado el ${todayStr}</div>
                ...
                {filteredCaptaciones.map((item) => (
                  ...
                  >
                    <div className="flex-1 min-w-0 pr-2">
                      ...
                      <p className="text-xs text-zinc-200 truncate mb-2">{item.owner_name}</p>
                      
                      <div className="flex items-center gap-2 text-[10px] text-zinc-400 font-primary font-medium">
            ...
            <form onSubmit={handleCreate} className="flex-1 flex flex-col h-full">
              <div className="p-6 border-b border-[#1F1F1F] flex justify-between items-center bg-[#0F0F0F]">
                <div>
                  ...
                  <p className="text-xs text-zinc-300 font-primary">Completa los datos del propietario y del inmueble</p>
                </div>
                <button
                  type="button"
              ...
              <div className="flex-1 p-6 space-y-6 overflow-y-auto font-primary text-sm">
                ...
                <div className="space-y-4">
                  ...
                  <div className="flex flex-col gap-1">
                    <label className="text-xs text-zinc-200">Notas iniciales de seguimiento</label>
                    <textarea
                      value={notes}
                  ...
                  <section>
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                      ...
                      <div className="flex items-center gap-3 bg-[#111] border border-[#1F1F1F] p-3 rounded">
                        <Briefcase className="w-4 h-4 text-[#C9A962]" />
                        <div>
                          <span className="block text-[10px] text-zinc-400 uppercase font-bold tracking-wider">Última Actualización</span>
                          <span className="text-sm font-semibold text-[#FAF8F5]">
