  ...
  return (
    <div className="w-full bg-[#050505] min-h-screen">
      ...
      <section className="relative z-10 w-full px-6 md:px-14 py-16 max-w-[1600px] mx-auto">
        ...
        <div className="mb-12 relative overflow-hidden rounded-sm bg-gradient-to-r from-[#0A0A0A] to-[#1A1A1A] border border-[#25D366]/20 shadow-[0_0_30px_rgba(37,211,102,0.05)]">
          <div className="absolute top-0 right-0 w-64 h-64 bg-[#25D366]/5 rounded-full blur-[80px] -translate-y-1/2 translate-x-1/3" />
          <div className="relative z-10 flex flex-col md:flex-row items-center justify-between p-6 md:p-8 gap-6">
            <div className="flex items-center gap-6">
              <div className="w-16 h-16 flex items-center justify-center bg-[#25D366]/10 rounded-full shrink-0">
              ...
              <div>
                <h3 className="font-secondary text-xl md:text-2xl text-white mb-2">¿Buscas alquiler y no quieres perderte nada?</h3>
                <p className="font-primary text-sm text-white/60">Únete a nuestra comunidad de WhatsApp y sé el primero en enterarte de nuestras nuevas propiedades de alquiler con un solo clic.</p>
              </div>
            </div>
            <a 
