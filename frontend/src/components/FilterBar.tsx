  ...
  return (
    <div className="w-full flex md:flex-row flex-col gap-3 p-4 md:py-4 md:px-14 bg-[#0A0A0A] border-b border-[#1F1F1F]">
      <div className="flex-1 flex items-center h-11 bg-[#161616] border border-[#1F1F1F] px-4 gap-2">
        <Search size={16} className="text-[#FAF8F5]/55" />
        <input 
          type="text" 
          placeholder={t('search.placeholder')} 
          className="bg-transparent border-none outline-none text-[13px] font-primary w-full text-[#FAF8F5] placeholder:text-[#FAF8F5]/45"
        />
      </div>
      <div className="flex gap-3">
        <select className="h-11 bg-[#161616] border border-[#1F1F1F] px-4 text-[12px] font-primary text-[#FAF8F5]/70 outline-none w-full md:w-[160px] cursor-pointer">
