...
export const PropertyComparator = ({ properties = [], onRemove, onClear }: any) => {
  ...
  return (
    <div className="fixed bottom-0 left-0 right-0 z-[9999] bg-[#0A0A0A] border-t-2 border-[#C9A962] flex flex-col shadow-[0_-20px_100px_rgba(0,0,0,0.9)] max-h-[90vh] overflow-hidden">
      {/* Slim Header */}
      <div className="flex items-center justify-between px-6 py-3 border-b border-white/5 bg-[#111] shrink-0">
