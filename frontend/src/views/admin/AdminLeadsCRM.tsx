                ...
                {leads.map((lead: LeadCRM) => (
                  ...
                  >
                    ...
                    <div className="flex-1 min-w-0 pr-8">
                      ...
                      <div className="text-xs text-[#888] truncate mb-1">
                ...
                {selectedLead.target_property && (
                  <section className="bg-[#111] border border-[#1F1F1F] rounded-lg p-4 flex flex-col md:flex-row gap-4 items-center">
                    ...
                    <div className="flex-1 text-center md:text-left">
                      <span className="text-[9px] text-[#888] uppercase font-bold tracking-wider block">Propiedad de interés principal</span>
                    ...
                    <div className="flex flex-col gap-2 w-full md:w-auto">
                      <a
                        ...
                        target="_blank"
                        rel="noopener noreferrer"
                        className="bg-[#1A1A1A] border border-[#333] hover:border-[#C9A962] text-[#FAF8F5] text-xs font-bold uppercase tracking-wider px-4 py-2 rounded-sm text-center transition-all block"
                      >
                        Ver Ficha
                      </a>
                      {selectedLead.phone && (
                        ...
                        {leadMatches.map(p => (
                          <div key={p.id} className="min-w-[200px] max-w-[200px] bg-[#111] border border-[#1F1F1F] rounded-lg overflow-hidden flex-shrink-0 flex flex-col justify-between">
                            <div>
                              ...
                              <div className="p-2.5">
                                <span className="text-[8px] text-[#888] uppercase block">Ref: {p.reference}</span>
                ...
                <div className="space-y-4">
                  ...
                  {newLeadIntent === 'comprar' ? (
                    <div className="flex items-center gap-2 py-2">
                      ...
                      />
                      <label htmlFor="mortgageApproved" className="text-xs text-[#888] uppercase font-bold select-none cursor-pointer">
                    ...
                    <div className="grid grid-cols-2 gap-4 py-2">
                      <div className="flex items-center gap-2">
                        <input
                          ...
                          className="rounded border-[#1F1F1F] bg-[#111] text-[#C9A962] focus:ring-[#C9A962]"
                        />
                        <label htmlFor="hasPets" className="text-xs text-[#888] uppercase font-bold select-none cursor-pointer">
                          ¿Tiene Mascotas?
                        </label>
                      </div>
                      <div>
                        <label className="block text-[10px] uppercase font-bold text-[#888] mb-1">Fecha Entrada Deseada</label>
                        <input
                          type="date"
