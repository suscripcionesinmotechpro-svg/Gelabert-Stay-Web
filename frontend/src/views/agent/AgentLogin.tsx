...
export const AgentLogin = () => {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    // Navigation handled by useEffect above once userProfile loads
  };
    ...
    <div className="min-h-screen bg-[#0A0A0A] flex items-center justify-center p-6 relative">
      <div className="w-full max-w-md">
        ...
        <div className="flex flex-col items-center mb-10 gap-3">
          ...
          <p className="font-primary text-[#666666] text-xs tracking-[0.3em] uppercase">Portal del Agente</p>
        </div>
        ...
        >
          <div className="flex items-center gap-3 pb-4 border-b border-[#1F1F1F]">
            ...
            <h2 className="font-primary text-[#FAF8F5] font-bold text-lg tracking-tight">Acceso de Agente</h2>
          </div>
        ...
        <p className="text-center font-primary text-[#444444] text-[10px] mt-8 uppercase tracking-widest opacity-60">
          Acceso exclusivo para agentes autorizados
        </p>
      </div>
    </div>
  );
