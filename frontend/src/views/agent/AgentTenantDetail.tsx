...
export const AgentTenantDetail = () => {
  ...
  if (!tenant) {
    return (
      <div className="flex flex-col items-center gap-4 py-20 text-[#444]">
        ...
        <Link to="/agente/inquilinos" className="text-[#C9A962] text-sm hover:underline">Volver</Link>
      </div>
    );
  }
    ...
    <div className="flex flex-col gap-6 max-w-5xl">
      ...
      <div className="flex items-start justify-between gap-4 flex-wrap">
        <div className="flex items-center gap-4">
          <button onClick={() => navigate('/agente/inquilinos')} className="text-[#666] hover:text-[#FAF8F5] transition-colors">
        ...
        <div className="flex items-center gap-2 flex-wrap">
          ...
          <Link
            to={`/agente/inquilinos/${id}/editar`}
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
        ...
        <div className="md:col-span-2 flex flex-col gap-5">
          ...
          <div className="flex items-center justify-between">
            ...
            <Link
              to={`/agente/contratos/nuevo?tenant_id=${id}`}
          ...
          {loadingContracts ? (
            ...
            <div className="bg-[#0A0A0A] border border-dashed border-[#2A2A2A] p-8 flex flex-col items-center gap-3 text-[#444]">
              ...
              <Link to={`/agente/contratos/nuevo?tenant_id=${id}`}
                ...
                <div className="bg-[#0A0A0A] border border-[#1F1F1F] p-5 flex flex-col gap-4">
                  <div className="flex items-start justify-between gap-4 flex-wrap">
                    ...
                    <div className="flex gap-2">
                      <Link to={`/agente/contratos/${displayContract.id}/editar`}
                  ...
                  <div className="grid grid-cols-2 sm:grid-cols-4 gap-3">
                    ...
                    <div>
                      ...
                      {displayContract.property_id ? (
                        <Link to={`/agente/propiedades/${displayContract.property_id}/editar`} className="font-primary text-sm text-[#C9A962] hover:underline font-semibold">
                          ...
                          {TENANT_DOC_TYPES.map(docType => {
                            ...
                            return (
                              <div 
                                ...
                                className="border border-[#1A1A1A] hover:border-[#C9A962] p-3 flex flex-col gap-2 bg-[#050505] hover:bg-[#C9A962]/5 transition-all duration-300 ease-in-out cursor-pointer group rounded-sm"
                              >
                                <p className="font-primary text-xs text-[#888] group-hover:text-[#FAF8F5] font-semibold transition-colors duration-300">{DOCUMENT_TYPE_LABELS[docType]}</p>
                                {existing.map(doc => (
                                  <div key={doc.id} className="flex items-center gap-1.5">
                                    ...
                                    <button
                                      onClick={(e) => {
                                        e.stopPropagation();
                                        handleDownload(doc.id, doc.file_path, doc.file_url, doc.file_name);
                                      }}
                                ...
                                <button
                                  onClick={(e) => {
                                    e.stopPropagation();
                                    triggerUpload(docType, 'tenant');
                                  }}
                                  disabled={isUploading}
                                  className="flex items-center gap-1 text-[#444] group-hover:text-[#C9A962] group-hover:underline font-primary text-[10px] transition-all duration-300 disabled:opacity-50"
                                >
                                  {isUploading ? <Loader2 className="w-3 h-3 animate-spin" /> : <Upload className="w-3 h-3 text-[#444] group-hover:text-[#C9A962]" />}
